(function () {
  ...
  function hasAlfredAccess() {
    try {
      if (typeof window.hasAlfredFeaturePermission === 'function') {
        return !!window.hasAlfredFeaturePermission();
      }
    } catch (e) {}
    return false;
  }

  function hideAlfredUi() {
    ...
    var toast = document.getElementById('alfredToast');
    if (toast) toast.classList.remove('show');
  }

  function showAlfredUi() {
    var fab = document.getElementById('enhancementsFab');
